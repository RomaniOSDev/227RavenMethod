...
• Optional photo picker: you may attach photos from your library to journal entries. Selected images are stored locally on your device only and are never uploaded.
• The app does not request access to your camera, microphone, location, contacts, motion sensors, or HealthKit.
